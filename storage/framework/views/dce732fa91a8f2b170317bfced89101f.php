...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="HomePage">
            <img
                src="<?php echo e(URL::asset('assets/img/fatortk.png')); ?>" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="HomePage"><img
                src="<?php echo e(URL::asset('assets/img/fatortk.png')); ?>" class="main-logo dark-theme"
                alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="HomePage"><img
                src="<?php echo e(URL::asset('assets/img/fatortk.png')); ?>" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="HomePage"><img
                src="<?php echo e(URL::asset('assets/img/fatortk.png')); ?>" class="logo-icon dark-theme"
                alt="logo"></a>
    </div>
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="<?php echo e(auth()->user()->profile_photo_path ? asset('storage/' . auth()->user()->profile_photo_path) : asset('assets/img/faces/6.jpg')); ?>">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('homepage')); ?>"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                        <path
                            d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                    </svg><span class="side-menu__label">الصفحة الرئيسية</span><span
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير')): ?>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="<?php echo e(url('/' . ($page = '#'))); ?>"><svg
                        ...
                        </svg><span class="side-menu__label">فواتير</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('قائمة الفواتير')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('invoices')); ?>">قائمه الفواتير </a></li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير المدفوعة')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('payed_invoices')); ?>">فواتير مدفوعه </a></li>
                        <?php endif; ?>


                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير الغير مدفوعة')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('Due_invoices')); ?>">فواتير غير مدفوع</a></li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير المدفوعة جزئيا')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('partially_paid_invoices')); ?>">فواتير المدفوعه جزئياً</a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ارشيف الفواتير')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('archives.index')); ?>">أرشيف الفواتير</a></li>
                        <?php endif; ?>
            ...
            <?php endif; ?> <li class="slide">
                ...
                <ul class="slide-menu">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تقرير الفواتير')): ?>
                    <li><a class="slide-item" href="<?php echo e(route('invoice_report')); ?>">تقارير الفواتير </a></li>

                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تقرير العملاء')): ?>
                    <li><a class="slide-item" href="<?php echo e(route('customer_report')); ?>">تقارير العملاء</a></li>
...
<<<<<<< HEAD
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('المستخدمين')): ?>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('قائمة المستخدمين')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('users.index')); ?>">قائمه المستخدمين</a></li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('صلاحيات المستخدمين')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('roles.index')); ?>">صلاحيات المستخدمين </a></li>
                        <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الاعدادات')): ?>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الاقسام')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('sections.index')); ?>">العملاء</a></li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('المنتجات')): ?>
                            <li><a class="slide-item" href="<?php echo e(route('products.index')); ?>">المنتجات</a></li>
                        <?php endif; ?>
...
<!-- main-sidebar -->
<?php /**PATH D:\projectss\Invoice_System\resources\views/layouts/main-sidebar.blade.php ENDPATH**/ ?>