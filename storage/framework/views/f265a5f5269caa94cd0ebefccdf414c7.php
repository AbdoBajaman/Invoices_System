...
<?php $__env->startSection('title'); ?>
    المستخدمين -فاتورتك للادارة الفواتير
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="label d-flex text-<?php echo e($user->is_active == 1 ? 'success' : 'danger'); ?>">
                                            <div class="dot-label bg-<?php echo e($user->is_active == 1 ? 'success' : 'danger'); ?> ml-1"></div>
                                            <?php echo e($user->is_active == 1 ? 'مفعل' : 'غير مفعل'); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/users/users.blade.php ENDPATH**/ ?>