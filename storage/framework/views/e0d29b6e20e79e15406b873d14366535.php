...
<?php if(session()->has('deleted_atchived_invoice')): ?>
    {
    <script>
...
<?php if(session()->has('fail_deleted_atchived_invoice')): ?>
    {
    <script>
        window.onload = function() {
            notif({
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="<?php echo e(route('archives.destroy', 'test')); ?>" method="post">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="<?php echo e(route('archives.update', 'fail')); ?>" method="POST">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/Invoices/Archive_invoices.blade.php ENDPATH**/ ?>