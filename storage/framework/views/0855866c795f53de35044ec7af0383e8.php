...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('المصادقة الثنائية')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('أضف أمانًا إضافيًا لحسابك باستخدام المصادقة الثنائية.')); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <h3 class="text-lg font-medium text-gray-900">
            <!--[if BLOCK]><![endif]--><?php if($this->enabled): ?>
                <!--[if BLOCK]><![endif]--><?php if($showingConfirmation): ?>
                    <?php echo e(__('أكمل تمكين المصادقة الثنائية.')); ?>

                <?php else: ?>
                    <?php echo e(__('لقد قمت بتمكين المصادقة الثنائية.')); ?>

                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <?php else: ?>
                <?php echo e(__('لم تقم بتمكين المصادقة الثنائية.')); ?>
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                <?php echo e(__('عندما تكون المصادقة الثنائية مفعلة، ستُطلب منك رمز أمان عشوائي خلال عملية تسجيل الدخول. يمكنك الحصول على هذا الرمز من تطبيق مصادقة جوجل  على هاتفك.')); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($showingQrCode): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <!--[if BLOCK]><![endif]--><?php if($showingConfirmation): ?>
                            <?php echo e(__('لإكمال تمكين المصادقة الثنائية، قم بمسح رمز الاستجابة السريعة التالي باستخدام تطبيق المصادقة على هاتفك أو أدخل مفتاح الإعداد وقدم الرمز OTP الذي تم توليده.')); ?>

                        <?php else: ?>
                            <?php echo e(__('المصادقة الثنائية مفعلة الآن. قم بمسح رمز الاستجابة السريعة التالي باستخدام تطبيق المصادقة على هاتفك أو أدخل مفتاح الإعداد.')); ?>
                ...
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('مفتاح الإعداد')); ?>: <?php echo e(decrypt($this->user->two_factor_secret)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'code','value' => ''.e(__('الرمز')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'code','value' => ''.e(__('الرمز')).'']); ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($showingRecoveryCodes): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('قم بتخزين هذه الرموز الاحتياطية في مدير كلمات مرور آمن. يمكن استخدامها لاستعادة الوصول إلى حسابك إذا فقدت جهاز المصادقة الثنائية.')); ?>
...
<?php $component->withAttributes(['class' => 'me-3']); ?>
                            <?php echo e(__('تجديد الرموز الاحتياطية')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'me-3']); ?>
                            <?php echo e(__('عرض الرموز الاحتياطية')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Invoice_System\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>