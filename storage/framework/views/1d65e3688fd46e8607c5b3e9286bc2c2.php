...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('جلسات المتصفح')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('إدارة وتسجيل الخروج من الجلسات النشطة الأخرى على المتصفحات والأجهزة.')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600">
            <?php echo e(__('إذا لزم الأمر، يمكنك تسجيل الخروج من جميع جلسات المتصفح الأخرى عبر جميع أجهزتك. بعض جلساتك الأخيرة مدرجة أدناه؛ ومع ذلك، قد لا تكون هذه القائمة شاملة. إذا شعرت أن حسابك قد تم اختراقه، يجب عليك أيضًا تحديث كلمة المرور الخاصة بك.')); ?>

        </div>

        <!--[if BLOCK]><![endif]--><?php if(count($this->sessions) > 0): ?>
            <div class="mt-5 space-y-6">
                <!-- جلسات المتصفح الأخرى -->
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-sm text-gray-600">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : __('غير معروف')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('غير معروف')); ?>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($session->is_current_device): ?>
                                        <span class="text-green-500 font-semibold"><?php echo e(__('هذا الجهاز')); ?></span>
                                    <?php else: ?>
                                        <?php echo e(__('آخر نشاط')); ?> <?php echo e($session->last_active); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('تسجيل الخروج من جلسات المتصفح الأخرى')); ?>
...
<?php endif; ?>
        ...
        <!-- تأكيد تسجيل الخروج من الأجهزة الأخرى -->
...
<?php $component->withAttributes(['wire:model.live' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('يرجى إدخال كلمة المرور الخاصة بك لتأكيد أنك ترغب في تسجيل الخروج من جلسات المتصفح الأخرى عبر جميع أجهزتك.')); ?>


                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('كلمة المرور')).'','xRef' => 'password','wire:model' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('كلمة المرور')).'','x-ref' => 'password','wire:model' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Invoice_System\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>