                            ...
                            <tbody>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class=""><?php echo e($products->product_name); ?></td>
                                        <td class=""><?php echo e($products->sections->section_name); ?></td>
                                        <td class=""> <?php echo e($products->description); ?></td>
                                        ...
                                        <td class=''>
                                            ...
                                            data-product_name="<?php echo e($products->product_name); ?>"
                                            data-description="<?php echo e($products->description); ?>"
                                            data-section_name="<?php echo e($products->sections->section_name); ?>"
                                            ...
                                            <form id="delete-form-<?php echo e($products->id); ?>" action="<?php echo e(route('products.destroy',$products->id)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="button" class="btn btn-outline-danger" onclick="confirmDelete('<?php echo e($products->id); ?>','<?php echo e($products->product_name); ?>')"
                                                    title="حذف">حذف
                                                </button>
                                            </form>
                                            <?php endif; ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('products.store')); ?>" method="post" autocomplete="off">
                            <?php echo csrf_field(); ?>
                            ...
                            <select required class="form-control" name="section_name" id="section_name">
                                ...
                                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    <option value="<?php echo e($section->section_name  ?? 'لايوجد'); ?>">
                                        <?php echo e($section->section_name ?? 'لا يوجد'); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo e(route('products.update', 1)); ?>" method="post" autocomplete="off">
                            ...
                            <select required class="form-control" name="section_name" id="section_name">
                            <option value="" disabled>اختر العميل</option>
                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sections): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sections->section_name); ?>">
                                    <?php echo e($sections->section_name); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/products/products.blade.php ENDPATH**/ ?>