...
اضافة الصلاحيات - فاتورتك  للادارة القانونية
                    ...
                    <div class="main-content-label mg-b-5">
                        <div class="col-xs-7 col-sm-7 col-md-7">
                            <div class="form-group">
                                <p>اسم الصلاحية :</p>
                                <input type="text" name="name" class="form-control" placeholder="اسم الصلاحية" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/roles/create_role.blade.php ENDPATH**/ ?>