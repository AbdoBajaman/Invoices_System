...
<?php $__env->startSection('title'); ?>
    تقرير الفواتير -فاتورتك لأدارة الفواتير
                ...
                <form action="<?php echo e(route('Search_invoices')); ?>" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p disblaed class="mg-b-10">تحديد نوع الفواتير</p>
                            <select class="form-control select2"
                                name="type" required>
                                
                                <option  value="<?php echo e($type ?? 'حدد نوع الفواتير'); ?>" selected>
                                    <?php echo e($type ?? 'حدد نوع الفواتير'); ?>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($invoice->invoice_dte); ?></td>
                                        <td><?php echo e($invoice->due_date); ?></td>
                                        <td><?php echo e($invoice->product); ?></td>
                                        <td><a
                                                href="<?php echo e(route('invoice_details.show',$invoice->id )); ?>"><?php echo e($invoice->sections->section_name); ?></a>
                                        </td>
                                        <td><?php echo e($invoice->discount); ?></td>
                                        <td><?php echo e($invoice->rate_tax); ?></td>
                                        <td><?php echo e($invoice->value_tax); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/reports/invoices_reports.blade.php ENDPATH**/ ?>