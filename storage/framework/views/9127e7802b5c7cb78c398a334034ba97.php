...
<?php endif; ?>
        ...
        <div class="mb-4 text-sm text-gray-600">
            <?php echo e(__('نسيت كلمة المرور؟ لا مشكلة. فقط أخبرنا بعنوان بريدك الإلكتروني وسنرسل لك رابط إعادة تعيين كلمة المرور الذي سيمكنك من اختيار واحدة جديدة.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'email','value' => ''.e(__('البريد الإلكتروني')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'email','value' => ''.e(__('البريد الإلكتروني')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(__('إرسال رابط إعادة تعيين كلمة المرور')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Invoice_System\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>