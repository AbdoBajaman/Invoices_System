...
<?php if(session()->has('Archive_invoice')): ?>
    {
    <script>
        window.onload = function() {
            notif({
...
<?php endif; ?>
<?php if(session()->has('restore_invoice')): ?>
    {
    <script>
        window.onload = function() {
            notif({
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-xl-t-0 d-flex justify-content-between mt-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('اضافة فاتورة')): ?>
                        <a class="btn btn-outline-primary w-50  ml-2" href="<?php echo e(route('invoices.create')); ?>">
                            <i class='fas fa-plus'></i>&nbsp;
                            اضافه فاتوره</a>
                    <?php endif; ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تصدير EXCEL')): ?>
                        <a class="btn btn-outline-primary w-50" href="invoices/export/">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/invoices/invoices.blade.php ENDPATH**/ ?>