                    ...
                    <form action="<?php echo e(route('invoices.store')); ?>" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <input id="invoice_Date" class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <select name="section_id" class="form-control SlectBox"
                                    onclick="console.log('this'+$(this).val())" onchange="console.log('change is firing')">
                                    <!--placeholder-->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" id="value_tax" name="value_tax" readonly>
                            </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        function myFunction() {
            ...
            var rate_tax = parseFloat(document.getElementById("rate_tax").value);
            var value_tax = parseFloat(document.getElementById("value_tax").value);
           console.log(Discount)

           console.log(rate_tax)
           console.log(value_tax)

            if (isNaN(Discount) || Discount === '' || typeof Discount === 'undefined') {
                Discount = 0;
            }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/Invoices/Add_Invoice.blade.php ENDPATH**/ ?>