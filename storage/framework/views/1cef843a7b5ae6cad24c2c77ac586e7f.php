...
<?php $__env->startSection('title'); ?>
    تقرير العملاء -فاتورتك لأدارة الفواتير
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="<?php echo e(route('search_customer')); ?>" method="GET" role="search" autocomplete="off">
                   <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/reports/customer_reports.blade.php ENDPATH**/ ?>