...
<!-- Favicon -->
<link rel="icon" href="<?php echo e(URL::asset('assets/img/fatortk.png')); ?>" type="image/x-icon">
<!-- Icons css -->
...
<?php /**PATH C:\Invoice_System\resources\views/layouts/head.blade.php ENDPATH**/ ?>