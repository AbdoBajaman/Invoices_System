...
<link href="<?php echo e(URL::asset('assets/plugins/darggable/jquery-ui-darggable.css')); ?>" rel="stylesheet">
					...
					<div class="row row-sm">
						<div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
							...
							<div class="card custom-card card-draggable">
								<img alt="Image" class="img-fluid card-img-top" src="<?php echo e(URL::asset('assets/img/photos/1.jpg')); ?>">
								<div class="card-body">
...
<script src="<?php echo e(URL::asset('assets/plugins/darggable/jquery-ui-darggable.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/plugins/darggable/darggable.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/darggablecards.blade.php ENDPATH**/ ?>