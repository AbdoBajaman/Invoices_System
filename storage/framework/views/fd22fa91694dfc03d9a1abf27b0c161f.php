									...
									<div class="card-sigin">
										...
										<div class="main-signup-header">
											...
											<div class="main-signup-footer mt-5">
												<p>Already have an account? <a href="<?php echo e(url('/' . $page='signin')); ?>">Sign In</a></p>
											</div>
										</div>
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Invoice_System\resources\views/signup.blade.php ENDPATH**/ ?>