    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('search_customer')}}" method="GET" role="search" autocomplete="off">
                   @csrf
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{route('invoice_details.show',$invoice->id)}}">{{ $invoice->sections->section_name }}</a>
                                        </td>
                                        <td>{{ $invoice->discount }}</td>
                                        <td>{{ $invoice->rate_tax }}</td>
                                        <td>{{ $invoice->value_tax }}</td>
                                        <td>{{ $invoice->total }}</td>
                                        <td>
