<x-action-section>
    ...
    <x-slot name="description">
        {{ __('إدارة وتسجيل الخروج من الجلسات النشطة الأخرى على المتصفحات والأجهزة.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('يرجى إدخال كلمة المرور الخاصة بك لتأكيد أنك ترغب في تسجيل الخروج من جلسات المتصفح الأخرى عبر جميع أجهزتك.') }}
