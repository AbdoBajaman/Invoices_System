            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ auth()->user()->profile_photo_path ? asset('storage/' . auth()->user()->profile_photo_path) : asset('assets/img/faces/6.jpg') }}">
        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ route('invoices') }}">قائمه الفواتير </a></li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('payed_invoices') }}">فواتير مدفوعه </a></li>
                        @endcan


                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('Due_invoices') }}">فواتير غير مدفوع</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('partially_paid_invoices') }}">فواتير المدفوعه جزئياً</a>
                            </li>
                        @endcan
            ...
            @endcan <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('تقرير الفواتير')
                    <li><a class="slide-item" href="{{ route('invoice_report') }}">تقارير الفواتير </a></li>

                    @endcan
                    @can('تقرير العملاء')
                    <li><a class="slide-item" href="{{ route('customer_report')}}">تقارير العملاء</a></li>
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
                            <img alt="user-img" class="avatar avatar-xl brround" src="{{ asset('storage/'.(auth()->user()->profile_photo_path ?? 'faces/6.jpg')) }}"><span class="avatar-status profile-status bg-green"></span>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{route('payed_invoices')}}">فواتير مدفوعه </a></li>
							<li><a class="slide-item" href="{{route('Due_invoices')}}">فواتير غير مدفوع</a></li>
                            <li><a class="slide-item" href="{{route('partially_paid_invoices')}}">فواتير  المدفوعه جزئياً</a></li>
                            <li><a class="slide-item" href="{{route('archives.index')}}">أرشيف الفواتير</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ route('users.index') }}">قائمه المستخدمين</a></li>
                        @endcan
