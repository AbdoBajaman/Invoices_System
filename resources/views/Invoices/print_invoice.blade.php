                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>{{$invoice->sections->section_name}}</h6>
                                    <p>بويش<br>
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span class="">تاريخ الدفع</span>
                                    <span>{{ $invoice_details->Payment_Date ?? $invoice_details->Status }}</span>
                                </p>
                            </div>
                        </div>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        {{-- <th class="tx-right">المبلغ المدفوع</th> --}}
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        {{-- <td class="tx-right">
                                            {{number_format( $invoice_details->payed_value , 2)}}
                                        </td> --}}
                                        <td class="tx-right">
                                            {{ number_format($invoice->Amount_Commission, 2) }}
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">{{ $invoice->rate_tax }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2"> {{ number_format($invoice->total, 2) }}
                                        </td>
...
{{-- <span class=" tx-red"></span> --}}
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">                                            {{ number_format($invoice->Amount_collection - $invoice_details->payed_value, 2) }}
                                            </h4>
                                        </td>
