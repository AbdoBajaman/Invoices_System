                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_date" type="text"
                                    value="{{ $invoices->invoice_date }}" required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        @if ($section->id != $invoices->sections->id)
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_tax" id="rate_tax" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="{{ $invoices->rate_tax }}">{{ $invoices->rate_tax }}</option>


                                    @if ($invoices->rate_tax == '5%')
                                        <option value=" 0%">0%</option>
                                        <option value="10%">10%</option>
                                    @elseif ($invoices->rate_tax == '0%')
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="value_tax" name="value_tax"
                                    value="{{ $invoices->value_tax }}" readonly>
                            </div>
