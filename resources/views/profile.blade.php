								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{ auth()->user()->profile_photo_path ? asset('storage/' . auth()->user()->profile_photo_path) : asset('assets/img/faces/6.jpg') }}">
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									...
									<div class="tab-pane" id="profile">
										<div class="row">
											<div class="col-sm-4">
												<div class="border p-1 card thumb">
													<a href="#" class="image-popup" title="Screenshot-2">
														<img src="{{URL::asset('assets/img/photos/7.jpg')}}" class="thumb-img" alt="work-thumbnail">
													</a>
											...
											<div class="col-sm-4">
												<div class="border p-1 card thumb">
													<a href="#" class="image-popup" title="Screenshot-2">
														<img src="{{URL::asset('assets/img/photos/8.jpg')}}" class="thumb-img" alt="work-thumbnail">
													</a>
													<h4 class="text-center tx-14 mt-3 mb-0">صورة المعرض</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>التصوير</small></p>
											...
											<div class="col-sm-4">
												<div class="border p-1 card thumb">
													<a href="#" class="image-popup" title="Screenshot-2">
														<img src="{{URL::asset('assets/img/photos/9.jpg')}}" class="thumb-img" alt="work-thumbnail">
													</a>
													<h4 class="text-center tx-14 mt-3 mb-0">صورة المعرض</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>التصوير</small></p>
											...
											<div class="col-sm-4">
												<div class="border p-1 card thumb mb-xl-0">
													<a href="#" class="image-popup" title="Screenshot-2">
														<img src="{{URL::asset('assets/img/photos/10.jpg')}}" class="thumb-img" alt="work-thumbnail">
													</a>
													<h4 class="text-center tx-14 mt-3 mb-0">صورة المعرض</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>التصوير</small></p>
									...
									<div class="tab-pane" id="settings">
										<form role="form">
											...
											<div class="form-group">
												<label for="RePassword">تأكيد</label>
